...
export const Cabecalho: React.FC = () => {
  ...
  return (
    <header className="w-full bg-white p-5 shadow-md sticky top-0 z-50 
      ...
      {/* Menu Dropdown Móvel */}
      {/* Aparece abaixo do header, apenas se 'isMenuOpen' for true */}
        ...
        <ul className="flex flex-col items-center gap-4 p-5">
          <li>
            <Link 
              to="/checkin" 
              onClick={handleLinkClick}
              className="text-green-600 font-bold hover:text-green-400 dark:text-green-400 dark:hover:text-green-300"
            >
              Fazer Check-in
            </Link>
          </li>
          <li>
            <Link 
              to="/dashboard" 
              onClick={handleLinkClick}
              className="text-purple-600 font-bold hover:text-purple-400 dark:text-purple-400 dark:hover:text-purple-300"
            >
              Dashboard
            </Link>
          </li>
          ...
          <li>
            <Link 
              to="/gerenciar" 
              onClick={handleLinkClick}
              className="text-blue-600 font-bold hover:text-blue-400 dark:text-blue-400 dark:hover:text-blue-300"
            >
              Gerenciar
            </Link>
          </li>
